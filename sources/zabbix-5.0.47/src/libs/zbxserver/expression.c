 ...
 *                                                                            *
 ******************************************************************************/
/* build-and-test: Alpine 3.24's libxml2 (2.13.9) declares xmlStructuredErrorFunc's error parameter as
 * `const xmlError *`; the non-const `xmlErrorPtr` this function used to take no longer matches that
 * signature and fails to compile. Pure type-signature fix, no logic change. */
