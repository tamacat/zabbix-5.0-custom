 ...
 *                                                                            *
 ******************************************************************************/
/* build-and-test: same libxml2 const-correctness fix as src/libs/zbxserver/expression.c — Alpine
 * 3.24's libxml2 (2.13.9) requires `const xmlError *`, not the old non-const `xmlErrorPtr`. */
