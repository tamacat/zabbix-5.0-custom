...
class MysqlDbBackend extends DbBackend {
	...
	*/
	...
	public function connect($host, $port, $user, $password, $dbname, $schema) {
		...
		// build-and-test: PHP8's mysqli::real_connect() types $flags as non-nullable int (default 0);
		// this used to default to null, which is now deprecated. 0 is the correct "no flags" value.
		$tls_mode = 0;
