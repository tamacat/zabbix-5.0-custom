...
class CLineGraphDraw extends CGraphDraw {
	...
	// build-and-test: PHP8.2 deprecates dynamic properties; these were all assigned in the constructor
	// below or elsewhere in this class without being declared (properties shared with the CGraphDraw
	// base class, e.g. $data/$items/$sizeX, are declared there instead).
	protected $triggers;
	protected $yaxis;
	protected $ymin_type;
	protected $ymax_type;
	protected $yaxismin;
	protected $yaxismax;
	protected $ymin_itemid;
	protected $ymax_itemid;
	protected $percentile;
	protected $outer;
	protected $show_work_period;
	protected $show_triggers;
	protected $zero;
	protected $cell_width;
	protected $cell_height_min;
	protected $intervals;
	protected $power;
	protected $drawItemsLegend;
	protected $drawExLegend;
	protected $itemsHost;
	protected $unit2px;
	protected $oxy;
