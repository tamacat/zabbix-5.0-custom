...
class CPieGraphDraw extends CGraphDraw {
	...
	// below or elsewhere in this class without being declared ($sum is declared on the CGraphDraw base
	// class instead, since it's shared with CLineGraphDraw).
	protected $background;
	protected $exploderad;
	protected $exploderad3d;
	protected $graphheight3d;
	protected $shiftlegendright;
	protected $dataFrom;
	protected $shiftYLegend;
