...
class CArrayHelper {
	...
	public static function sort(array &$array, array $fields) {
		...
		self::$fields = $fields;
		// build-and-test: PHP8.2 deprecates the literal 'self' string in a callable array;
		// self::class resolves to the same defining class name without that deprecation.
