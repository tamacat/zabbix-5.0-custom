...
class CMultiSelect extends CTag {
	...
	/**
	 * build-and-test: PHP8.2 deprecates dynamic properties; these two were assigned without being
	 * declared (js_event_name in the constructor below, params likewise).
	 *
	 * @var string
	 */
	protected $js_event_name;
