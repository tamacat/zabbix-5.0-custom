...
class CSetupWizard extends CForm {
	...
	// build-and-test: PHP8.2 deprecates dynamic properties; this was assigned in the constructor below
	...
	private function stage2(): array {
		...
		if ($this->STEP_FAILED) {
			...
			$message_box = makeMessageBox(ZBX_STYLE_MSG_BAD, $ZBX_MESSAGES, _('Cannot connect to the database.'), false,
				true
			);
		}
		else {
