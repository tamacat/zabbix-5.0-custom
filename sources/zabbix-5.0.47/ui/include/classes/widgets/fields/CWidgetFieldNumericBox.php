...
class CWidgetFieldNumericBox extends CWidgetField {
	...
	// build-and-test: PHP8.2 deprecates dynamic properties; getMaxLength() below reads this without it
	// ever being declared (or, apparently, ever assigned — always null in practice).
	private $max;
